# Análisis de Emails del Flujo Partners - Trial Period

## 📊 Resumen General

Se envían **11 emails automatizados** durante el período de trial de 30 días + 7 días post-trial. El objetivo es mantener engagement y maximizar conversión a planes pagos antes/en el **día 25** (cuando se revela el precio).
...
- ✔️ Explicación: pricing se revelará en día 25
- ✔️ CTA: Abrir dashboard
...
- 📈 Traveler clicks
- ✅ Profile completion %
- 📧 Inquiry routing status (on/off)
- 📧 Delivery inbox status
...
- Clicks (total)
- Favorites (total)
- Contextual guidance si profile < 80%
...
- ⚡ Instant activation options
  - Card payment (inmediato)
  - Invoice request (pending)
- ⏰ 5 días para mantener badge
...
**Tono**: Urgencia moderada, oferta clara, decisión simple
...
- ✅ **Scarcity**: "Featured slots are limited to maintain partner exclusivity"
...
- 📌 Consequence: badge se elimina automáticamente
...
- 📊 Reminder: features en cada tier
...
- 📅 Next billing date
- 💳 Payment method confirmado

**Tono**: Confirmación, no venta
...
- 👥 Guest count
- 💬 Inquiry message (in styled box)
- 📍 Source surface (hotel_detail, explore_card, etc.)
...
- 📊 Click snapshot
- 📎 PDF attachment con detalles

**Tono**: Reporting profesional, insights
...
## 💡 RECOMENDACIONES PARA CATCH/RETENCIÓN

### **Antes del Día 25 (Semanas 1-3)**

**Objetivo**: Maximizar engagement y preparar decisión de pricing

1. **Enrich Day 7 Report**:
   - Agregar benchmark vs. otros hoteles en tier/región
   - Incluir "Top 3 quick wins this week"
   - Social proof: % de partners que completan setup en week 1

2. **Add Day 10-12 Micro-Email** (NUEVO):
   - Subject: "Check your message from a real traveler" (si hay inquiries)
   - o: "You're 40% through your trial - here's what's working" (data-driven)
   - Objetivo: Mantener weekly engagement, no spam

3. **Enhance Day 15 Midpoint**:
   - Interactive checklist: "Complete these 3 things before day 25"
   - ROI preview: "Your visibility path for next 12 months"
   - Success rate callout: "37% of partners at your performance level upgrade"

4. **Optimize Day 21 Pre-Pricing Email**:
   - Title: "Your hidden opportunity (revealed on day 25)"
   - Tease top 2 features que sólo en Preferred/Featured
   - Include: "What partners like you are upgrading to"

---

### **En/Alrededor del Día 25 (CRÍTICO)**

**ESTE ES EL MOMENTO MÁS IMPORTANTE**

1. **Segmentación estratégica**:
   - **Segment A** (Reach > 500): "You're ready for Featured - premium placement"
   - **Segment B** (Reach 100-500): "Preferred unlocks inquiry routing - direct leads"
...
2. **Day 25 Email Enhancement**:
   ...
   - SOCIAL PROOF: "89% of partners upgrade within 48h after seeing pricing"
   - SEGMENTED CTA:
     * Si high performer: "Upgrade to Featured"
     * Si medium: "Try Preferred (inquiry routing)"
     * Si low: "Keep Verified + get setup help"
   - URGENCY OVERLAY: "First month 25% off if activated by day 27"
   - ALTERNATIVE: "Schedule a 20-min strategy call (we'll recommend the right plan)"
   ```

3. **Day 26 Follow-up** (NUEVO):
   - IF no action: Segundo email dentro de 20-24h
   - Subject: "You saw day 25 pricing - questions?"
   - Incluir: Small case study + direct chat/call link
   - Offer: "Extended trial window (7 extra días) while you decide"

4. **Day 27-28 Sequence**:
   - Mantener actual pero ADD: Flash discount window
   - "Activate by EOD tomorrow and get Month 1 at 50% off"
   - Direct phone CTA (no just dashboard)

---

### **Días 30-37 (Post-Removal Recovery)**

1. **Day 30 Email Automation**:
   - Trigger CRM/Zoho action: Marcar para human follow-up
   - Send: Invitation para "Free 30-min strategy call"
   - Ofrecer: "We'll help you find the right plan"

2. **Day 32-35 "Come Back" Campaign**:
   - Subject line: "We noticed you're offline - here's what changed"
   - Tease: "New partners from last month are seeing X% more visibility"
   - Offer: "Extended trial: 7 extra días + discount if you restart"

3. **Day 37 Closure**:
   - Last email but NOT final
   - Include: "You can still upgrade anytime - here's how"
   - Open door for manual sales team: "Let us know if you want to chat"

---

## 📋 CHECKLIST: Información Diferenciada por Email

**Actual state**: Cada email muestra performance metrics + contexto de setup
