// src/helpers/bookingCertificate.js
...
function buildPDF(doc, b) {
  ...
  doc.font("Helvetica-Bold").fontSize(24).fillColor("#fff").text("Insider Bookings", 48, 52)
  doc.font("Helvetica").fontSize(14).fillColor("#f97316").text("Booking Confirmation", 48, 82)

  // Details box
  let y = 130
  doc.roundedRect(36, y - 10, 540, 190, 8).fillAndStroke("#f8fafc", "#e5e7eb")
  ...
  y += 18
  drawLabelValue(doc, { xLabel: 56, xValue: 180, y, label: "Contact", value: hotel.phone || propertyContact || "-" })
  ...
  // Rates & Payment box
  y += 48
  doc.roundedRect(36, y, 540, 140, 8).fillAndStroke("#f8fafc", "#e5e7eb")
  ...
  doc.fillColor("#475569").text("Taxes and Fees", colR, y0 + 18, { width: 130, align: "right" })
  ...
  doc.font("Helvetica").fontSize(10).fillColor("#475569").text("Payment Method", colL, y0 + 74)
