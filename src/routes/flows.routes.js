...
router.post("/savebooking", authenticate, requireVerifiedEmail, saveBookingFlow);
router.post("/price", authenticate, priceFlow);
router.post("/preauth", authenticate, requireVerifiedEmail, preauthFlow);
router.post("/confirm", authenticate, requireVerifiedEmail, confirmFlow);
